...
"""))
        ...
        print("I couldn't calculate this topic and the reason why is python is just unable to calculate negative ln(ex: math.log(-5)).")
...
"""))
    ...
    # This is the part that calculates Number of Payments, Given ‘PV­Due '
        ...
        print("I couldn't calculate this formula the reason why python is just can't calculate negative ln what is mean is ex: math.log(-5). ")

# This is the part for feature 3.
elif feature == 3:
    print("This part is only avaliable for the company that I work for I'm solving their questions.")
