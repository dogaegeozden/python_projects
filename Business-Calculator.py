...
Periodic interest rate using future value and present value: PIR1
Equivalent Periodic Interest Rate: EPIR
Equivalent Nominal Interest Rate: ENIR
Number of Compounding Periods: NCP1
...
Number of Payments, Given 'FV­Due': NPGFVD ** I couldn' calculate this i wasn't sleep I will fix it as soon as possible.
Number of Payments, Given ‘PV­Due': NPGPVD ** I couldn't calcuate this one I'm sorry
""")
print()

# Hello my name is Doga. Sorry I couldn't calculate some of the topics
# python is just unable to calculate negative ln. I can always provide
...
Enter your periodic rate of interest here:
"""))
        ncp1 = math.log( fv / pv ) / math.log( 1 + i )
        print("Result: ",ncp1)
...
"""))
    ...
    # This is the part that calculates number of periods given for present value.
        ...
        print("Can't calculate this one. I'm sory python is just unable to calculate negative ln.(ex: math.log(-5)")
...
# This is the part for feature 3.
    ...
    print("This part is only avaliable for the company that I work for.")
